-- Movementz Phase 36: repair paid coach provisioning.
-- Run this in Supabase if paid coach checkout succeeds but the user remains a free/normal user.
-- This makes the role guard allow trusted payment provisioning, then recreates the paid coach RPC.
