-- Movementz Phase 37: pending coach signup profile.
-- Run this in Supabase before testing paid coach signup again.
-- It lets the server prepare a coach profile before Stripe payment without
-- unlocking the coach dashboard until the subscription webhook confirms payment.
